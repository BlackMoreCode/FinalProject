                ...
                <Box sx={{ marginTop: 2 }}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                        <Button
                            ...
                            sx={{ marginLeft: 'auto', backgroundColor: 'white', color: '#6a4e23', boxShadow: 'none','&:hover': {
    ...
    }> = ({ comment, onReplySubmit, onDeleteComment, toggleReplies, expanded, memberId }) => {
        const [replyContent, setReplyContent] = useState<string>('');
                ...
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    {memberId === comment.memberId && (
                        <Button
                            ...
                            sx={{ marginLeft: 2, backgroundColor: 'white', color: '#6a4e23', '&:hover': { backgroundColor: '#f5f5f5' } }}
                        >
                            삭제
                        </Button>
                    )}
                    ...
                    <Button
                        ...
                        sx={{ marginLeft: 'auto', backgroundColor: '#ffffff', color: '#6a4e23', '&:hover': { backgroundColor: '#f5f5f5' } }}
                    >
                        {expanded ? '답글 숨기기' : '답글'}
                    </Button>
                </Box>
                                ...
                                <Box key={reply.commentId} sx={{ marginBottom: 1, paddingLeft: 4 }}>
                                    ...
                                    {memberId === reply.memberId && (
                                        <Button
                                            ...
                                            sx={{ marginLeft: 2, backgroundColor: '#ff4444', color: 'white', '&:hover': { backgroundColor: '#cc0000' } }}
                                        >
                                            삭제
                                        </Button>
                                    )}
